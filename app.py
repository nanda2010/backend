...
def create_app():
    # Absolute path tracking for enterprise hosting
    ...
    def serve_static(path):
        # Exclude API routes from the catch-all to prevent conflicts
        if path.startswith('api/'):
            # If we are here, it means no blueprint matched /api/...
